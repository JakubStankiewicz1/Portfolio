        ...
        <div className="hero-bottom">
          ...
          <div className="circular-github-button">
            <Magnet padding={30} magnetStrength={1.5} activeTransition="transform 0.2s ease-out" inactiveTransition="transform 0.4s ease-in-out">
              <a href="https://github.com/JakubStankiewicz1/Rentiva" target="_blank" rel="noopener noreferrer">
                Github repo
              </a>
            </Magnet>
          </div>
          ...
          <div className="circular-live-button">
            <Magnet padding={30} magnetStrength={1.5} activeTransition="transform 0.2s ease-out" inactiveTransition="transform 0.4s ease-in-out">
              <a href="https://rentiva-frontend.onrender.com/" target="_blank" rel="noopener noreferrer">
                Live site ↗
              </a>
            </Magnet>
          </div>
          ...
          <div className="large-project-image">
            <img src={assets.rentivaOne} alt="Qitchen Project" />

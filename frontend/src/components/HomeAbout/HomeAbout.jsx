          ...
          <div className="homeAboutTextSection">
            <div className="homeAboutTextContent">
              ...
              <div className="homeAboutDescription">
                ...
                >
                  As a dedicated Cybersecurity student with a passion for web development, I'm actively seeking opportunities as a Frontend Developer.
                  My academic background in cybersecurity provides me with a unique perspective on building secure, robust web applications.
                </ScrollReveal>
                ...
                <ScrollReveal
                  ...
                  textClassName="homeAboutScrollText"
                >
                  I thrive on creating modern, responsive web applications using cutting-edge technologies like React, JavaScript, and contemporary
                  CSS frameworks. My approach combines security-first thinking with innovative design patterns to deliver exceptional user
                  experiences.
                </ScrollReveal>
                ...
                <ScrollReveal
                  ...
                  textClassName="homeAboutScrollText"
                >
                  Always eager to learn and embrace new challenges, I'm constantly expanding my skillset and exploring emerging technologies in the
